	...
	void OnGUI()
	{
		...
		if( GUILayout.Button( "Bounce and Tween Color" ) )
		{
			...
			var flow = new TweenFlow().add( 0, () => { return GoKitLite.instance.positionTo( cube, 1f, new Vector3( 0, 0, 0 ) ); } )
				.add( 1, () => { return GoKitLite.instance.positionTo( cube, 1f, new Vector3( 0, 5, 0 ) ); } )
				.add( 2, () => { return GoKitLite.instance.positionTo( cube, 1f, new Vector3( 0, 0, 0 ) ); } )
				.add( 3, () => { return GoKitLite.instance.positionTo( cube, 1f, new Vector3( 0, 5, 0 ) ); } )
				.add( 4, () => { return GoKitLite.instance.positionTo( cube, 1f, new Vector3( 0, 0, 0 ) ); } );
